...
type Build struct {
	...
	Host 	   string    `json:"host" xorm:"host not null varchar(255)"`
	Port 	   string    `json:"port" xorm:"port not null varchar(255)"`
	Apiversion string    `json:"apiversion" xorm:"apiversion not null varchar(255)"`
	Path 	   string    `json:"path" xorm:"path not null varchar(255)"`
}
